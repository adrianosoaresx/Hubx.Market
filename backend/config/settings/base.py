...
PAYMENTS_HUBX_SPLIT_ENABLED = os.getenv("PAYMENTS_HUBX_SPLIT_ENABLED", "0").strip().lower() in {"1", "true", "yes", "on"}
ASAAS_HUBX_WALLET_ID = os.getenv("ASAAS_HUBX_WALLET_ID", "").strip()
PAYMENTS_PLATFORM_BILLING_ASAAS_ENABLED = os.getenv("PAYMENTS_PLATFORM_BILLING_ASAAS_ENABLED", "0").strip().lower() in {"1", "true", "yes", "on"}
ASAAS_PLATFORM_BILLING_REMOTE_IP = os.getenv("ASAAS_PLATFORM_BILLING_REMOTE_IP", "").strip()
ASAAS_PLATFORM_BILLING_DUE_DAYS = int(os.getenv("ASAAS_PLATFORM_BILLING_DUE_DAYS", "3") or "3")
SUBSCRIPTIONS_PRO_DELINQUENCY_GRACE_DAYS = int(os.getenv("SUBSCRIPTIONS_PRO_DELINQUENCY_GRACE_DAYS", "5") or "5")
SUBSCRIPTIONS_PRO_DELINQUENCY_SUSPEND_DAYS = int(os.getenv("SUBSCRIPTIONS_PRO_DELINQUENCY_SUSPEND_DAYS", "15") or "15")
