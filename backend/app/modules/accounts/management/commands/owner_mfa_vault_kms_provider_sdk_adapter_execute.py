...
class Command(BaseCommand):
    help = "Captura evidência do branch SDK lazy do provider Vault/KMS TOTP MFA owner/admin."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            ...
            f"target_provider={result['target_provider']} sdk_adapter_enabled={result['sdk_adapter_enabled']} "
