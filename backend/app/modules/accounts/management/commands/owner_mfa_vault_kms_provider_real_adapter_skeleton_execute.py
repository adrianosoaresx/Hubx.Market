...
class Command(BaseCommand):
    help = "Captura evidência do skeleton real/mocável do adapter Vault/KMS TOTP MFA owner/admin."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            ...
            f"target_provider={result['target_provider']} real_adapter_enabled={result['real_adapter_enabled']} "
