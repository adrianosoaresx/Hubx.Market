...
class Command(BaseCommand):
    help = "Fecha ou consolida a cadência de expansão Hashicorp Vault MFA owner/admin."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            f"[{str(closure['status']).upper()}] result={closure['result']} cadence_status={closure['cadence_status']} "
