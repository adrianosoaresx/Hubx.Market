...
class CustomerAreaViewTests(TestCase):
    def test_account_orders_view_renders_design_system_template(self):
        ...
        self.assertContains(response, "a loja continua disponível para explorar produtos")
...
class CustomerAreaPersistedReadTests(TestCase):
    ...
    def test_customer_area_query_service_uses_persisted_sources_when_available(self):
        ...
        self.assertIn("loja segue disponível", orders_payload["table_description"].lower())
        self.assertIn("loja segue disponível", orders_payload["empty_description"].lower())
        ...
        self.assertIn("loja segue disponível", order_detail_payload["page_description"].lower())
        ...
        self.assertIn("loja segue disponível", order_detail_payload["summary_note"].lower())
        ...
        self.assertIn("loja segue disponível", order_detail_payload["activity_description"].lower())
    ...
    def test_customer_area_views_render_persisted_records_when_present(self):
        ...
        self.assertContains(orders_response, "loja continua disponível")
        ...
        self.assertContains(order_detail_response, "loja segue disponível")
    ...
    def test_account_order_detail_polishes_completed_order_perception(self):
        ...
        self.assertIn("pronta para voltar à loja", payload["page_meta"].lower())
        ...
        self.assertIn("loja continua sendo o melhor ponto", payload["activity_description"].lower())
        ...
        self.assertContains(response, "Pronta para voltar à loja")
