...
class AdminMerchantOperationsViewTests(TestCase):
    ...
    def test_merchant_ops_dashboard_renders_operational_cockpit(self):
        ...
        self.assertContains(response, "Atividades recentes")
        self.assertNotContains(response, "Sinais por módulo")
        self.assertNotContains(response, ">Leitura<")
        self.assertNotContains(response, "Data/Hora")
