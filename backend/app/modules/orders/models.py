...
class Order(models.Model):
    ...
    payment_source_label = models.CharField(max_length=64, blank=True)
    ...
    inventory_recovered_at = models.DateTimeField(null=True, blank=True)
    inventory_finalized_at = models.DateTimeField(null=True, blank=True)
    inventory_exception_under_review_at = models.DateTimeField(null=True, blank=True)
    inventory_exception_resolved_at = models.DateTimeField(null=True, blank=True)
    inventory_exception_owner_label = models.CharField(max_length=120, blank=True)
...
class OrderItem(models.Model):
    ...
    product_id_snapshot = models.PositiveIntegerField(null=True, blank=True)
    product_slug_snapshot = models.SlugField(max_length=255, blank=True)
